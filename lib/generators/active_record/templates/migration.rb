class TwoFactorAuthenticationAddTo<%= table_name.camelize %> < ActiveRecord::Migration[<%= Rails::VERSION::MAJOR %>.<%= Rails::VERSION::MINOR %>]
  ...
  def change
    ...
    add_column :<%= table_name %>, :direct_otp_delivery_method, :string
